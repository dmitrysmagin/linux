...
/*
 * jz4770_tve.c -- Ingenic Jz4760 TVE Controller
 *
...
struct jz4760tve_info jz4760_tve_info_PAL = {
	.ctrl		= TVE_CTRL_ECVBS |
			  (4 << TVE_CTRL_YCDLY_BIT) |
			  TVE_CTRL_SYNCT |
			  TVE_CTRL_PAL |
			  TVE_CTRL_SWRST,	/* PAL, SVIDEO */
	.frcfg		= (22 << TVE_FRCFG_L1ST_BIT) |
			  (625 << TVE_FRCFG_NLINE_BIT),
	.slcfg1		= (891 << TVE_SLCFG1_WHITEL_BIT) |
			  (384 << TVE_SLCFG1_BLACKL_BIT),
	.slcfg2		= (378 << TVE_SLCFG2_VBLANKL_BIT) |
			  (378 << TVE_SLCFG2_BLANKL_BIT),
	.slcfg3		= (240 << TVE_SLCFG3_SYNCL_BIT),
	.ltcfg1		= (19 << TVE_LTCFG1_FRONTP_BIT) |
			  (64 << TVE_LTCFG1_HSYNCW_BIT) |
			  (77 << TVE_LTCFG1_BACKP_BIT),
	.ltcfg2		= (1408 << TVE_LTCFG2_ACTLIN_BIT) |
	...
	.cbcrcfg	= (23 << TVE_CBCRCFG_CBBA_BIT) |
			  (23 << TVE_CBCRCFG_CRBA_BIT) |
			  (137 << TVE_CBCRCFG_CBGAIN_BIT) |
			  (137 << TVE_CBCRCFG_CRGAIN_BIT), /* CBGAIN CRGAIN??? */
...
/* default as PAL mode */
struct jz4760tve_info *jz4760_tve_info = &jz4760_tve_info_PAL;

void jz4760tve_enable_tve(void)
{
	/* enable tve controller, enable DACn??? */
	jz4760_tve_info->ctrl = (jz4760_tve_info->ctrl | TVE_CTRL_DAPD) &
				~(TVE_CTRL_DAPD1 | TVE_CTRL_DAPD2);
	jz4760_tve_info->ctrl &= ~TVE_CTRL_SWRST;

	jz4760_tve_info->ctrl |= (1 << 21);
	REG_TVE_CTRL |= (1 << 21);
